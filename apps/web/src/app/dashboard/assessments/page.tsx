...
import { AlertTriangle, BookOpen, CheckSquare, Clock, Loader2, Info } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-6">
        Test your knowledge and earn badges. Assessments you have already passed will not be shown here.
      </p>
        ...
        <Card>
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-gray-500">
              There are currently no new assessments for you to take. Check back later or ensure your subscription is active.
            </p>
          </CardContent>
        </Card>
      ) : (
